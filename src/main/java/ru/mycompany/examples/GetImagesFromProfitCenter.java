...
public class GetImagesFromProfitCenter {
      ...
      while (count >= 0) {
        ...
        for (WebElement element : webElements) {
          ...
          if (isSelected) {
            ...
            if (!sqLiteProvider.isExistImageInProfitCentrTable(picture)) {
              sqLiteProvider.addImageInProfitCentrTable(nameImage, picture);
