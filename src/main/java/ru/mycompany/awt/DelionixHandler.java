...
////================================
    ...
    private boolean goToPaidSurfing() {
        ...
        try {
            ...
            List<WebElement> dataElements = WEB_DRIVER.findElements(By.xpath("//*/table[@class='work-serf']"));
            System.out.println(dataElements.size());
            ...
            for (WebElement element : dataElements) {
                ...
                WebElement divLink = element.findElement(By.xpath("./tbody/tr/td[2]/div"));
                String id = divLink.getAttribute("id");
                if (id.equals("start-serf-{ID}")) {
                    continue;
                }
...
//        }
    ...
    private boolean goToYouTube() {
        ...
        try {
            ...
            List<WebElement> dataElements = WEB_DRIVER.findElements(By.xpath("//*/tbody/tr/td[2]/div/a"));
            System.out.println(dataElements.size());
            if (dataElements.isEmpty()) {
                return true;
            }
...
//        }
    ...
    private boolean enterAccountData() {
        WebElement webElement = getElementByXpathWithCount("//*/input[@name='username']", 30);
        if (webElement == null) {
            return false;
        }
    ...
    private WebElement getElementByXpathByElementWithCount(WebElement element, String xpath, int count) {
        WebElement webElement;
        for (int i = 0; i < count; i++) {
            pause(2000);
            try {
