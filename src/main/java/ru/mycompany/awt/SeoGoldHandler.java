...
public class SeoGoldHandler implements Handler {
  ...
  public SeoGoldHandler(WebDriver webDriver, User user) throws AWTException {
    this.sitename = "seogold";
    ...
    this.URL = "https://seo-gold.ru/login";
